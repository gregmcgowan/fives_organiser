...
class GetContactsUseCaseTest {
    ...
    @Test
    fun `get contacts when none are already added`() =
        runTest {
    ...
    @Test
    fun `get contacts when player is added already`() =
        runTest {
            val fixtContacts: List<Contact> = fixture.createList()
    ...
    fun `get contacts throws when player repo throws`() =
        runTest {
    ...
    @Test(expected = RuntimeException::class)
    fun `get contacts when contact importer throws`() =
        runTest {
            fakePlayerRepo.players = mutableListOf()
